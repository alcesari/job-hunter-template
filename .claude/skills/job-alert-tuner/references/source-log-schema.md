...
| `modalita_lavoro` | no | enum | `in_sede` \| `ibrido` \| `da_remoto`. Presente solo se la fonte lo dichiara — **assente, mai indovinato**. Oggi lo popola `linkedin_alert` dall'HTML dell'email (~70% delle card). Serve al tuner per misurare quanta parte del funnel è compatibile coi vincoli di trasferimento dell'utente senza aprire ogni annuncio. |
| `retribuzione` | no | string | La retribuzione **verbatim** della fonte (es. `39.773 €-43.445 € all'anno`), quando dichiarata (~27% degli annunci). Il dettaglio strutturato (`fonte`, `parsed`) vive in `staging.yaml`, non qui: nel log basta la stringa per misurare la copertura run dopo run. **Informativa**: non ha mai prodotto e non deve produrre un `esito: scartato_*`. |
...
{"run_id":"2026-07-05T06:00:00Z","intento_id":"data-engineering-eu","fonte":"linkedin_alert","ricerca_id":"data-engineering-eu:linkedin_alert:data-engineer-or-etl-developer:102890719","annuncio_id":"linkedin_alert:azienda-y:etl-developer:amsterdam","esito":"incluso_da_verificare","titolo":"ETL Developer","azienda":"Azienda Y","location":"Amsterdam","modalita_lavoro":"ibrido","retribuzione":"39.773 €-43.445 € all'anno"}
{"run_id":"2026-07-05T06:00:00Z","intento_id":"data-engineering-eu","fonte":"linkedin_alert","ricerca_id":"data-engineering-eu:linkedin_alert:data-engineer-or-etl-developer:102890719","annuncio_id":"linkedin_alert:azienda-z:data-engineer:milano","esito":"incluso_principale","titolo":"Data Engineer","azienda":"Azienda Z","location":"Milano","modalita_lavoro":"da_remoto"}
